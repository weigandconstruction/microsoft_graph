...
defmodule MicrosoftGraph.Model.MicrosoftGraphWindowsDefenderAdvancedThreatProtectionConfiguration do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          :version => integer() | nil,
          :allowSampleSharing => boolean() | nil,
          :enableExpeditedTelemetryReporting => boolean() | nil
        }
