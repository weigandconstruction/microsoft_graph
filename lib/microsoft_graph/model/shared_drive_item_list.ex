...
defmodule MicrosoftGraph.Model.SharedDriveItemList do
  @moduledoc """
  ...
  def decode(value) do
    ...
    |> Deserializer.deserialize(
      :contentTypes,
      :list,
      MicrosoftGraph.Model.MicrosoftGraphContentType
    )
    ...
    |> Deserializer.deserialize(
      :operations,
      :list,
      MicrosoftGraph.Model.MicrosoftGraphRichLongRunningOperation
    )
    |> Deserializer.deserialize(
      :sharepointIds,
      :struct,
