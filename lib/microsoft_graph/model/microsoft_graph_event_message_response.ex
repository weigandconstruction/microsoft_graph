...
defmodule MicrosoftGraph.Model.MicrosoftGraphEventMessageResponse do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    ...
    :responseType => MicrosoftGraph.Model.EventMessageResponseResponseType.t | nil
  }
  ...
  def decode(value) do
    value
     ...
     |> Deserializer.deserialize(:responseType, :struct, MicrosoftGraph.Model.EventMessageResponseResponseType)
  end
end
