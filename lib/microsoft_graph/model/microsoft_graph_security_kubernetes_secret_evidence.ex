...
defmodule MicrosoftGraph.Model.MicrosoftGraphSecurityKubernetesSecretEvidence do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    ...
    :name => String.t | nil,
    :namespace => MicrosoftGraph.Model.KubernetesSecretEvidenceNamespace.t | nil,
  ...
  def decode(value) do
    value
     ...
     |> Deserializer.deserialize(:namespace, :struct, MicrosoftGraph.Model.KubernetesSecretEvidenceNamespace)
  end
end
