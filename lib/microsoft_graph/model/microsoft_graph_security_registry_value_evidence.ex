...
defmodule MicrosoftGraph.Model.MicrosoftGraphSecurityRegistryValueEvidence do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          :registryValue => String.t() | nil,
          :registryValueName => String.t() | nil,
          :registryValueType => String.t() | nil
        }
