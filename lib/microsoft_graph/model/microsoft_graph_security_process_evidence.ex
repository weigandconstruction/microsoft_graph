...
defmodule MicrosoftGraph.Model.MicrosoftGraphSecurityProcessEvidence do
  ...
  @type t :: %__MODULE__{
    ...
    :parentProcessImageFile => MicrosoftGraph.Model.ProcessEvidenceParentProcessImageFile.t | nil,
  ...
  def decode(value) do
    value
     ...
     |> Deserializer.deserialize(:imageFile, :struct, MicrosoftGraph.Model.ProcessEvidenceImageFile)
     |> Deserializer.deserialize(:parentProcessCreationDateTime, :datetime, nil)
     |> Deserializer.deserialize(:parentProcessImageFile, :struct, MicrosoftGraph.Model.ProcessEvidenceParentProcessImageFile)
     |> Deserializer.deserialize(:processCreationDateTime, :datetime, nil)
     |> Deserializer.deserialize(:userAccount, :struct, MicrosoftGraph.Model.ProcessEvidenceUserAccount)
  end
end
