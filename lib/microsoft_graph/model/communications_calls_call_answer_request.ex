...
defmodule MicrosoftGraph.Model.CommunicationsCallsCallAnswerRequest do
  ...
  @type t :: %__MODULE__{
          :acceptedModalities =>
            ...
            | nil,
          :callOptions =>
            MicrosoftGraph.Model.CommunicationsCallsCallAnswerRequestCallOptions.t() | nil,
  ...
  def decode(value) do
    ...
    |> Deserializer.deserialize(
      :callOptions,
      :struct,
      MicrosoftGraph.Model.CommunicationsCallsCallAnswerRequestCallOptions
    )
    |> Deserializer.deserialize(
      :mediaConfig,
      :struct,
      MicrosoftGraph.Model.MicrosoftGraphMediaConfig
    )
  end
end
