...
defmodule MicrosoftGraph.Model.MicrosoftGraphApplicationServicePrincipalServicePrincipal do
  ...
  @type t :: %__MODULE__{
          ...
          :delegatedPermissionClassifications =>
            [MicrosoftGraph.Model.MicrosoftGraphDelegatedPermissionClassification.t()] | nil,
          ...
          :samlSingleSignOnSettings =>
            MicrosoftGraph.Model.ServicePrincipalSamlSingleSignOnSettings.t() | nil,
          :tokenIssuancePolicies =>
          ...
          :remoteDesktopSecurityConfiguration =>
            MicrosoftGraph.Model.ServicePrincipalRemoteDesktopSecurityConfiguration.t() | nil,
          :oauth2PermissionGrants =>
          ...
          :resourceSpecificApplicationPermissions =>
            [MicrosoftGraph.Model.MicrosoftGraphResourceSpecificPermission.t()] | nil,
  ...
  def decode(value) do
    ...
    |> Deserializer.deserialize(
      :delegatedPermissionClassifications,
      :list,
      MicrosoftGraph.Model.MicrosoftGraphDelegatedPermissionClassification
    )
    ...
    |> Deserializer.deserialize(
      :samlSingleSignOnSettings,
      :struct,
      MicrosoftGraph.Model.ServicePrincipalSamlSingleSignOnSettings
    )
    |> Deserializer.deserialize(
      :tokenIssuancePolicies,
      :list,
    ...
    |> Deserializer.deserialize(
      :remoteDesktopSecurityConfiguration,
      :struct,
      MicrosoftGraph.Model.ServicePrincipalRemoteDesktopSecurityConfiguration
    )
    |> Deserializer.deserialize(
      :oauth2PermissionGrants,
      :list,
    ...
    |> Deserializer.deserialize(
      :verifiedPublisher,
      :struct,
      MicrosoftGraph.Model.ServicePrincipalVerifiedPublisher
    )
    |> Deserializer.deserialize(
      :memberOf,
      :list,
    ...
    |> Deserializer.deserialize(
      :resourceSpecificApplicationPermissions,
      :list,
      MicrosoftGraph.Model.MicrosoftGraphResourceSpecificPermission
    )
    |> Deserializer.deserialize(
      :keyCredentials,
      :list,
