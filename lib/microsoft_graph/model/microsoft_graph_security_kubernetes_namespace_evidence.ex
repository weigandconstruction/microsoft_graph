...
defmodule MicrosoftGraph.Model.MicrosoftGraphSecurityKubernetesNamespaceEvidence do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    ...
    :cluster => MicrosoftGraph.Model.KubernetesNamespaceEvidenceCluster.t | nil,
  ...
  def decode(value) do
    value
     ...
     |> Deserializer.deserialize(:cluster, :struct, MicrosoftGraph.Model.KubernetesNamespaceEvidenceCluster)
