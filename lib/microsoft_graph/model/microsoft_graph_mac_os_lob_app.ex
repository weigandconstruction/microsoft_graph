...
defmodule MicrosoftGraph.Model.MicrosoftGraphMacOsLobApp do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    ...
    :childApps => [MicrosoftGraph.Model.MacOsLobAppChildAppsInner.t] | nil,
    :ignoreVersionDetection => boolean() | nil,
    :installAsManaged => boolean() | nil,
    :md5Hash => [String.t] | nil,
    :md5HashChunkSize => integer() | nil,
    :minimumSupportedOperatingSystem => MicrosoftGraph.Model.MacOsDmgAppMinimumSupportedOperatingSystem.t | nil,
  ...
  def decode(value) do
    value
     ...
     |> Deserializer.deserialize(:childApps, :list, MicrosoftGraph.Model.MacOsLobAppChildAppsInner)
     |> Deserializer.deserialize(:minimumSupportedOperatingSystem, :struct, MicrosoftGraph.Model.MacOsDmgAppMinimumSupportedOperatingSystem)
  end
end
