...
defmodule MicrosoftGraph.Model.MicrosoftGraphSecurityBlobContainerEvidence do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    ...
    :name => String.t | nil,
    :storageResource => MicrosoftGraph.Model.BlobContainerEvidenceStorageResource.t | nil,
    :url => String.t | nil
  }
  ...
  def decode(value) do
    value
     ...
     |> Deserializer.deserialize(:storageResource, :struct, MicrosoftGraph.Model.BlobContainerEvidenceStorageResource)
  end
end
