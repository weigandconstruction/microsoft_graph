...
defmodule MicrosoftGraph.Model.DrivesDriveItemsDriveItemWorkbookFunctionsDurationRequest do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    ...
    :coupon => MicrosoftGraph.Model.DrivesDriveItemsDriveItemWorkbookFunctionsImSechRequestInumber.t | nil,
  ...
  def decode(value) do
    value
     ...
     |> Deserializer.deserialize(:coupon, :struct, MicrosoftGraph.Model.DrivesDriveItemsDriveItemWorkbookFunctionsImSechRequestInumber)
