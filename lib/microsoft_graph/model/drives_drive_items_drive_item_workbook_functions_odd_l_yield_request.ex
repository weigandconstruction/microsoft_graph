...
defmodule MicrosoftGraph.Model.DrivesDriveItemsDriveItemWorkbookFunctionsOddLYieldRequest do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    ...
    :lastInterest => MicrosoftGraph.Model.DrivesDriveItemsDriveItemWorkbookFunctionsImSechRequestInumber.t | nil,
  ...
  def decode(value) do
    value
     ...
     |> Deserializer.deserialize(:lastInterest, :struct, MicrosoftGraph.Model.DrivesDriveItemsDriveItemWorkbookFunctionsImSechRequestInumber)
