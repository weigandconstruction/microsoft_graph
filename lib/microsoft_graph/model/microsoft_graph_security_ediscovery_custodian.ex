...
defmodule MicrosoftGraph.Model.MicrosoftGraphSecurityEdiscoveryCustodian do
  ...
  @type t :: %__MODULE__{
          ...
          :email => String.t() | nil,
          :lastIndexOperation =>
            MicrosoftGraph.Model.EdiscoveryCustodianLastIndexOperation.t() | nil,
          :siteSources => [MicrosoftGraph.Model.MicrosoftGraphSecuritySiteSource.t()] | nil,
          :unifiedGroupSources =>
            [MicrosoftGraph.Model.MicrosoftGraphSecurityUnifiedGroupSource.t()] | nil,
  ...
  def decode(value) do
    ...
    |> Deserializer.deserialize(
      :lastIndexOperation,
      :struct,
      MicrosoftGraph.Model.EdiscoveryCustodianLastIndexOperation
    )
    |> Deserializer.deserialize(
      :siteSources,
      :list,
      MicrosoftGraph.Model.MicrosoftGraphSecuritySiteSource
    )
    |> Deserializer.deserialize(
      :unifiedGroupSources,
      :list,
      MicrosoftGraph.Model.MicrosoftGraphSecurityUnifiedGroupSource
    )
    |> Deserializer.deserialize(
      :userSources,
      :list,
      MicrosoftGraph.Model.MicrosoftGraphSecurityUserSource
    )
  end
end
