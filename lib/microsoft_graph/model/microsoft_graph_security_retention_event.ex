...
defmodule MicrosoftGraph.Model.MicrosoftGraphSecurityRetentionEvent do
  ...
  @type t :: %__MODULE__{
    ...
    :eventPropagationResults => [MicrosoftGraph.Model.RetentionEventEventPropagationResultsInner.t] | nil,
  ...
  def decode(value) do
    value
     ...
     |> Deserializer.deserialize(:eventPropagationResults, :list, MicrosoftGraph.Model.RetentionEventEventPropagationResultsInner)
     |> Deserializer.deserialize(:eventQueries, :list, MicrosoftGraph.Model.RetentionEventEventQueriesInner)
     |> Deserializer.deserialize(:eventStatus, :struct, MicrosoftGraph.Model.RetentionEventEventStatus)
     |> Deserializer.deserialize(:eventTriggerDateTime, :datetime, nil)
     |> Deserializer.deserialize(:lastModifiedBy, :struct, MicrosoftGraph.Model.RetentionEventLastModifiedBy)
     |> Deserializer.deserialize(:lastModifiedDateTime, :datetime, nil)
     |> Deserializer.deserialize(:lastStatusUpdateDateTime, :datetime, nil)
     |> Deserializer.deserialize(:retentionEventType, :struct, MicrosoftGraph.Model.RetentionEventRetentionEventType)
  end
end
