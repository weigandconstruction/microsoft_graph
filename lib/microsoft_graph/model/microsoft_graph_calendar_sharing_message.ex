...
defmodule MicrosoftGraph.Model.MicrosoftGraphCalendarSharingMessage do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    ...
    :canAccept => boolean() | nil,
    :sharingMessageAction => MicrosoftGraph.Model.CalendarSharingMessageSharingMessageAction.t | nil,
    :sharingMessageActions => [MicrosoftGraph.Model.CalendarSharingMessageSharingMessageAction.t] | nil,
    :suggestedCalendarName => String.t | nil
  }
  ...
  def decode(value) do
    value
     ...
     |> Deserializer.deserialize(:sharingMessageAction, :struct, MicrosoftGraph.Model.CalendarSharingMessageSharingMessageAction)
     |> Deserializer.deserialize(:sharingMessageActions, :list, MicrosoftGraph.Model.CalendarSharingMessageSharingMessageAction)
  end
end
