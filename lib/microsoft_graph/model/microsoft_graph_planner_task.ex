...
defmodule MicrosoftGraph.Model.MicrosoftGraphPlannerTask do
  ...
  @type t :: %__MODULE__{
          ...
          :assignedToTaskBoardFormat =>
            MicrosoftGraph.Model.PlannerTaskAssignedToTaskBoardFormat.t() | nil,
          :assigneePriority => String.t() | nil,
          :assignments => MicrosoftGraph.Model.PlannerTaskAssignments.t() | nil,
          :bucketId => String.t() | nil,
          :bucketTaskBoardFormat =>
            MicrosoftGraph.Model.PlannerTaskBucketTaskBoardFormat.t() | nil,
          ...
          :progressTaskBoardFormat =>
            MicrosoftGraph.Model.PlannerTaskProgressTaskBoardFormat.t() | nil,
  ...
  def decode(value) do
    ...
    |> Deserializer.deserialize(
      :appliedCategories,
      :struct,
      MicrosoftGraph.Model.PlannerTaskAppliedCategories
    )
    |> Deserializer.deserialize(
      :assignedToTaskBoardFormat,
      :struct,
      MicrosoftGraph.Model.PlannerTaskAssignedToTaskBoardFormat
    )
    |> Deserializer.deserialize(
      :assignments,
      :struct,
      MicrosoftGraph.Model.PlannerTaskAssignments
    )
    |> Deserializer.deserialize(
      :bucketTaskBoardFormat,
      :struct,
      MicrosoftGraph.Model.PlannerTaskBucketTaskBoardFormat
    )
    |> Deserializer.deserialize(
      :completedBy,
      :struct,
      MicrosoftGraph.Model.PlannerTaskCompletedBy
    )
    ...
    |> Deserializer.deserialize(
      :previewType,
      :struct,
      MicrosoftGraph.Model.PlannerTaskPreviewType
    )
    |> Deserializer.deserialize(
      :progressTaskBoardFormat,
      :struct,
      MicrosoftGraph.Model.PlannerTaskProgressTaskBoardFormat
    )
