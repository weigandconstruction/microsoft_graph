...
defmodule MicrosoftGraph.Model.CollectionOfUnifiedRoleEligibilityScheduleAllOfValueInner do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          :scheduleInfo =>
            MicrosoftGraph.Model.UnifiedRoleEligibilityScheduleScheduleInfo.t() | nil
        }
  ...
  def decode(value) do
    ...
    |> Deserializer.deserialize(
      :scheduleInfo,
      :struct,
      MicrosoftGraph.Model.UnifiedRoleEligibilityScheduleScheduleInfo
    )
  end
end
