...
defmodule MicrosoftGraph.Model.MicrosoftGraphManagedAndroidLobApp do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    ...
    :size => integer() | nil,
    :minimumSupportedOperatingSystem => MicrosoftGraph.Model.AndroidStoreAppMinimumSupportedOperatingSystem.t | nil,
  ...
  def decode(value) do
    value
     ...
     |> Deserializer.deserialize(:minimumSupportedOperatingSystem, :struct, MicrosoftGraph.Model.AndroidStoreAppMinimumSupportedOperatingSystem)
  end
end
