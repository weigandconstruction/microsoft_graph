...
defmodule MicrosoftGraph.Model.MicrosoftGraphManagedIosStoreApp do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    ...
    :minimumSupportedOperatingSystem => MicrosoftGraph.Model.MicrosoftGraphIosMinimumOperatingSystem.t | nil
  }
  ...
  def decode(value) do
    value
     ...
     |> Deserializer.deserialize(:minimumSupportedOperatingSystem, :struct, MicrosoftGraph.Model.MicrosoftGraphIosMinimumOperatingSystem)
  end
end
