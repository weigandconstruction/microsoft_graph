...
defmodule MicrosoftGraph.Model.MicrosoftGraphIosGeneralDeviceConfiguration do
  ...
  @type t :: %__MODULE__{
    ...
    :mediaContentRatingNewZealand => MicrosoftGraph.Model.IosGeneralDeviceConfigurationMediaContentRatingNewZealand.t | nil,
    ...
    :mediaContentRatingIreland => MicrosoftGraph.Model.IosGeneralDeviceConfigurationMediaContentRatingIreland.t | nil,
    :spotlightBlockInternetResults => boolean() | nil,
    :mediaContentRatingJapan => MicrosoftGraph.Model.IosGeneralDeviceConfigurationMediaContentRatingJapan.t | nil,
    ...
    :mediaContentRatingUnitedStates => MicrosoftGraph.Model.IosGeneralDeviceConfigurationMediaContentRatingUnitedStates.t | nil,
    :bluetoothBlockModification => boolean() | nil,
    :mediaContentRatingCanada => MicrosoftGraph.Model.IosGeneralDeviceConfigurationMediaContentRatingCanada.t | nil,
    :mediaContentRatingFrance => MicrosoftGraph.Model.IosGeneralDeviceConfigurationMediaContentRatingFrance.t | nil,
    ...
    :mediaContentRatingUnitedKingdom => MicrosoftGraph.Model.IosGeneralDeviceConfigurationMediaContentRatingUnitedKingdom.t | nil,
    ...
    :mediaContentRatingGermany => MicrosoftGraph.Model.IosGeneralDeviceConfigurationMediaContentRatingGermany.t | nil,
    ...
    :appsVisibilityList => [MicrosoftGraph.Model.MicrosoftGraphIosNetworkUsageRuleManagedAppsInner.t] | nil,
    ...
    :appsSingleAppModeList => [MicrosoftGraph.Model.MicrosoftGraphIosNetworkUsageRuleManagedAppsInner.t] | nil,
    ...
    :mediaContentRatingAustralia => MicrosoftGraph.Model.IosGeneralDeviceConfigurationMediaContentRatingAustralia.t | nil,
    :iBooksStoreBlockErotica => boolean() | nil,
    :siriBlocked => boolean() | nil,
    :cellularBlockVoiceRoaming => boolean() | nil,
    :safariCookieSettings => MicrosoftGraph.Model.MicrosoftGraphWebBrowserCookieSettings.t | nil,
    ...
    :networkUsageRules => [MicrosoftGraph.Model.IosGeneralDeviceConfigurationNetworkUsageRulesInner.t] | nil,
  ...
  def decode(value) do
    value
     ...
     |> Deserializer.deserialize(:appsVisibilityListType, :struct, MicrosoftGraph.Model.MicrosoftGraphAppListType)
     |> Deserializer.deserialize(:mediaContentRatingNewZealand, :struct, MicrosoftGraph.Model.IosGeneralDeviceConfigurationMediaContentRatingNewZealand)
     ...
     |> Deserializer.deserialize(:mediaContentRatingIreland, :struct, MicrosoftGraph.Model.IosGeneralDeviceConfigurationMediaContentRatingIreland)
     |> Deserializer.deserialize(:mediaContentRatingJapan, :struct, MicrosoftGraph.Model.IosGeneralDeviceConfigurationMediaContentRatingJapan)
     |> Deserializer.deserialize(:passcodeRequiredType, :struct, MicrosoftGraph.Model.MicrosoftGraphRequiredPasswordType)
     |> Deserializer.deserialize(:mediaContentRatingUnitedStates, :struct, MicrosoftGraph.Model.IosGeneralDeviceConfigurationMediaContentRatingUnitedStates)
     |> Deserializer.deserialize(:mediaContentRatingCanada, :struct, MicrosoftGraph.Model.IosGeneralDeviceConfigurationMediaContentRatingCanada)
     |> Deserializer.deserialize(:mediaContentRatingFrance, :struct, MicrosoftGraph.Model.IosGeneralDeviceConfigurationMediaContentRatingFrance)
     |> Deserializer.deserialize(:mediaContentRatingUnitedKingdom, :struct, MicrosoftGraph.Model.IosGeneralDeviceConfigurationMediaContentRatingUnitedKingdom)
     |> Deserializer.deserialize(:mediaContentRatingGermany, :struct, MicrosoftGraph.Model.IosGeneralDeviceConfigurationMediaContentRatingGermany)
     |> Deserializer.deserialize(:appsVisibilityList, :list, MicrosoftGraph.Model.MicrosoftGraphIosNetworkUsageRuleManagedAppsInner)
     |> Deserializer.deserialize(:appsSingleAppModeList, :list, MicrosoftGraph.Model.MicrosoftGraphIosNetworkUsageRuleManagedAppsInner)
     |> Deserializer.deserialize(:mediaContentRatingAustralia, :struct, MicrosoftGraph.Model.IosGeneralDeviceConfigurationMediaContentRatingAustralia)
     |> Deserializer.deserialize(:safariCookieSettings, :struct, MicrosoftGraph.Model.MicrosoftGraphWebBrowserCookieSettings)
     |> Deserializer.deserialize(:networkUsageRules, :list, MicrosoftGraph.Model.IosGeneralDeviceConfigurationNetworkUsageRulesInner)
     |> Deserializer.deserialize(:mediaContentRatingApps, :struct, MicrosoftGraph.Model.MicrosoftGraphRatingAppsType)
  end
end
