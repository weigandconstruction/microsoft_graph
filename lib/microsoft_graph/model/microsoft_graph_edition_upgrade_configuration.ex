...
defmodule MicrosoftGraph.Model.MicrosoftGraphEditionUpgradeConfiguration do
  ...
  def decode(value) do
    value
     ...
     |> Deserializer.deserialize(:licenseType, :struct, MicrosoftGraph.Model.MicrosoftGraphEditionUpgradeLicenseType)
     |> Deserializer.deserialize(:targetEdition, :struct, MicrosoftGraph.Model.MicrosoftGraphWindows10EditionType)
  end
end
