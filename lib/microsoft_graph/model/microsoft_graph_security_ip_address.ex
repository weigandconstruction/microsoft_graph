...
defmodule MicrosoftGraph.Model.MicrosoftGraphSecurityIpAddress do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    ...
    :autonomousSystem => MicrosoftGraph.Model.IpAddressAutonomousSystem.t | nil,
    :countryOrRegion => String.t | nil,
    :hostingProvider => String.t | nil,
    :netblock => String.t | nil
  }
  ...
  def decode(value) do
    value
     ...
     |> Deserializer.deserialize(:autonomousSystem, :struct, MicrosoftGraph.Model.IpAddressAutonomousSystem)
  end
end
