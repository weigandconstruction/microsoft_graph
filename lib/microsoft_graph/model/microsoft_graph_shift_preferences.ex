...
defmodule MicrosoftGraph.Model.MicrosoftGraphShiftPreferences do
  @moduledoc """
  ...
  def decode(value) do
    value
     ...
     |> Deserializer.deserialize(:availability, :list, MicrosoftGraph.Model.ShiftPreferencesAvailabilityInner)
  end
end
