...
defmodule MicrosoftGraph.Model.MicrosoftGraphAccessPackageResourceRequest do
  ...
  def decode(value) do
    ...
    |> Deserializer.deserialize(
      :catalog,
      :struct,
      MicrosoftGraph.Model.AccessPackageResourceRequestCatalog
    )
    |> Deserializer.deserialize(:createdDateTime, :datetime, nil)
    |> Deserializer.deserialize(
      :requestType,
      :struct,
      MicrosoftGraph.Model.AccessPackageResourceRequestRequestType
    )
    |> Deserializer.deserialize(
      :resource,
      :struct,
    ...
    |> Deserializer.deserialize(
      :state,
      :struct,
      MicrosoftGraph.Model.AccessPackageResourceRequestState
    )
  end
end
