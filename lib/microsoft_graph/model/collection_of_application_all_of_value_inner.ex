...
defmodule MicrosoftGraph.Model.CollectionOfApplicationAllOfValueInner do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    ...
    :requestSignatureVerification => MicrosoftGraph.Model.ApplicationRequestSignatureVerification.t | nil,
    ...
    :parentalControlSettings => MicrosoftGraph.Model.ApplicationParentalControlSettings.t | nil,
    ...
    :extensionProperties => [MicrosoftGraph.Model.MicrosoftGraphExtensionProperty.t] | nil,
    :tags => [String.t] | nil,
    :createdOnBehalfOf => MicrosoftGraph.Model.ApplicationCreatedOnBehalfOf.t | nil,
    :applicationTemplateId => String.t | nil,
    :servicePrincipalLockConfiguration => MicrosoftGraph.Model.ApplicationServicePrincipalLockConfiguration.t | nil,
    ...
    :requiredResourceAccess => [MicrosoftGraph.Model.MicrosoftGraphRequiredResourceAccess.t] | nil,
    :logo => String.t | nil,
  ...
  def decode(value) do
    value
     ...
     |> Deserializer.deserialize(:requestSignatureVerification, :struct, MicrosoftGraph.Model.ApplicationRequestSignatureVerification)
     ...
     |> Deserializer.deserialize(:parentalControlSettings, :struct, MicrosoftGraph.Model.ApplicationParentalControlSettings)
     ...
     |> Deserializer.deserialize(:optionalClaims, :struct, MicrosoftGraph.Model.ApplicationOptionalClaims)
     |> Deserializer.deserialize(:extensionProperties, :list, MicrosoftGraph.Model.MicrosoftGraphExtensionProperty)
     |> Deserializer.deserialize(:createdOnBehalfOf, :struct, MicrosoftGraph.Model.ApplicationCreatedOnBehalfOf)
     |> Deserializer.deserialize(:servicePrincipalLockConfiguration, :struct, MicrosoftGraph.Model.ApplicationServicePrincipalLockConfiguration)
     |> Deserializer.deserialize(:publicClient, :struct, MicrosoftGraph.Model.ApplicationPublicClient)
     |> Deserializer.deserialize(:addIns, :list, MicrosoftGraph.Model.MicrosoftGraphAddIn)
     |> Deserializer.deserialize(:verifiedPublisher, :struct, MicrosoftGraph.Model.ApplicationVerifiedPublisher)
     ...
     |> Deserializer.deserialize(:requiredResourceAccess, :list, MicrosoftGraph.Model.MicrosoftGraphRequiredResourceAccess)
     ...
     |> Deserializer.deserialize(:certification, :struct, MicrosoftGraph.Model.ApplicationCertification)
