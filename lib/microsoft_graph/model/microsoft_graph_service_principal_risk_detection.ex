...
defmodule MicrosoftGraph.Model.MicrosoftGraphServicePrincipalRiskDetection do
  ...
  @type t :: %__MODULE__{
          ...
          :detectionTimingType =>
            MicrosoftGraph.Model.ServicePrincipalRiskDetectionDetectionTimingType.t() | nil,
          ...
          :source => String.t() | nil,
          :tokenIssuerType =>
            MicrosoftGraph.Model.ServicePrincipalRiskDetectionTokenIssuerType.t() | nil
        }
  ...
  def decode(value) do
    ...
    |> Deserializer.deserialize(
      :activity,
      :struct,
      MicrosoftGraph.Model.ServicePrincipalRiskDetectionActivity
    )
    ...
    |> Deserializer.deserialize(
      :detectionTimingType,
      :struct,
      MicrosoftGraph.Model.ServicePrincipalRiskDetectionDetectionTimingType
    )
    |> Deserializer.deserialize(:lastUpdatedDateTime, :datetime, nil)
    |> Deserializer.deserialize(
      :location,
      :struct,
      MicrosoftGraph.Model.ServicePrincipalRiskDetectionLocation
    )
    |> Deserializer.deserialize(
      :riskDetail,
      :struct,
    ...
    |> Deserializer.deserialize(
      :riskLevel,
      :struct,
      MicrosoftGraph.Model.ServicePrincipalRiskDetectionRiskLevel
    )
    |> Deserializer.deserialize(
      :riskState,
      :struct,
      MicrosoftGraph.Model.ServicePrincipalRiskDetectionRiskState
    )
    |> Deserializer.deserialize(
      :tokenIssuerType,
      :struct,
      MicrosoftGraph.Model.ServicePrincipalRiskDetectionTokenIssuerType
    )
  end
end
