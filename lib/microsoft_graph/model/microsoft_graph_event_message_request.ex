...
defmodule MicrosoftGraph.Model.MicrosoftGraphEventMessageRequest do
  ...
  @type t :: %__MODULE__{
    ...
    :bccRecipients => [MicrosoftGraph.Model.MeCalendarGroupsCalendarGroupCalendarsCalendarCalendarViewEventInstancesEventForwardRequestToRecipientsInner.t] | nil,
    ...
    :inferenceClassification => MicrosoftGraph.Model.MessageInferenceClassification.t | nil,
    :internetMessageHeaders => [MicrosoftGraph.Model.MessageInternetMessageHeadersInner.t] | nil,
    ...
    :replyTo => [MicrosoftGraph.Model.MeCalendarGroupsCalendarGroupCalendarsCalendarCalendarViewEventInstancesEventForwardRequestToRecipientsInner.t] | nil,
    :sender => MicrosoftGraph.Model.MeCalendarGroupsCalendarGroupCalendarsCalendarCalendarViewEventInstancesEventForwardRequestToRecipientsInner.t | nil,
    ...
    :uniqueBody => MicrosoftGraph.Model.MeJoinedTeamsTeamSendActivityNotificationRequestPreviewText.t | nil,
    :webLink => String.t | nil,
    :endDateTime => MicrosoftGraph.Model.MeCalendarGroupsCalendarGroupCalendarsCalendarGetScheduleRequestEndTime.t | nil,
    ...
    :startDateTime => MicrosoftGraph.Model.MeCalendarGroupsCalendarGroupCalendarsCalendarGetScheduleRequestEndTime.t | nil,
    :type => MicrosoftGraph.Model.EventMessageType.t | nil,
    :allowNewTimeProposals => boolean() | nil,
    :meetingRequestType => MicrosoftGraph.Model.EventMessageRequestMeetingRequestType.t | nil,
    :previousEndDateTime => MicrosoftGraph.Model.EventMessageRequestPreviousEndDateTime.t | nil,
    :previousLocation => MicrosoftGraph.Model.EventMessageRequestPreviousLocation.t | nil,
    :previousStartDateTime => MicrosoftGraph.Model.EventMessageRequestPreviousStartDateTime.t | nil,
  ...
  def decode(value) do
    value
     ...
     |> Deserializer.deserialize(:bccRecipients, :list, MicrosoftGraph.Model.MeCalendarGroupsCalendarGroupCalendarsCalendarCalendarViewEventInstancesEventForwardRequestToRecipientsInner)
     ...
     |> Deserializer.deserialize(:inferenceClassification, :struct, MicrosoftGraph.Model.MessageInferenceClassification)
     |> Deserializer.deserialize(:internetMessageHeaders, :list, MicrosoftGraph.Model.MessageInternetMessageHeadersInner)
     ...
     |> Deserializer.deserialize(:replyTo, :list, MicrosoftGraph.Model.MeCalendarGroupsCalendarGroupCalendarsCalendarCalendarViewEventInstancesEventForwardRequestToRecipientsInner)
     |> Deserializer.deserialize(:sender, :struct, MicrosoftGraph.Model.MeCalendarGroupsCalendarGroupCalendarsCalendarCalendarViewEventInstancesEventForwardRequestToRecipientsInner)
     ...
     |> Deserializer.deserialize(:uniqueBody, :struct, MicrosoftGraph.Model.MeJoinedTeamsTeamSendActivityNotificationRequestPreviewText)
     |> Deserializer.deserialize(:endDateTime, :struct, MicrosoftGraph.Model.MeCalendarGroupsCalendarGroupCalendarsCalendarGetScheduleRequestEndTime)
     ...
     |> Deserializer.deserialize(:meetingMessageType, :struct, MicrosoftGraph.Model.EventMessageMeetingMessageType)
     |> Deserializer.deserialize(:recurrence, :struct, MicrosoftGraph.Model.EventMessageRecurrence)
     |> Deserializer.deserialize(:startDateTime, :struct, MicrosoftGraph.Model.MeCalendarGroupsCalendarGroupCalendarsCalendarGetScheduleRequestEndTime)
     |> Deserializer.deserialize(:type, :struct, MicrosoftGraph.Model.EventMessageType)
     |> Deserializer.deserialize(:meetingRequestType, :struct, MicrosoftGraph.Model.EventMessageRequestMeetingRequestType)
     |> Deserializer.deserialize(:previousEndDateTime, :struct, MicrosoftGraph.Model.EventMessageRequestPreviousEndDateTime)
     |> Deserializer.deserialize(:previousLocation, :struct, MicrosoftGraph.Model.EventMessageRequestPreviousLocation)
     |> Deserializer.deserialize(:previousStartDateTime, :struct, MicrosoftGraph.Model.EventMessageRequestPreviousStartDateTime)
  end
end
