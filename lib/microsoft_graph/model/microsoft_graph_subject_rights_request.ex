...
defmodule MicrosoftGraph.Model.MicrosoftGraphSubjectRightsRequest do
  ...
  @type t :: %__MODULE__{
    ...
    :mailboxLocations => MicrosoftGraph.Model.SubjectRightsRequestMailboxLocations.t | nil,
  ...
  def decode(value) do
    value
     ...
     |> Deserializer.deserialize(:assignedTo, :struct, MicrosoftGraph.Model.SubjectRightsRequestAssignedTo)
     ...
     |> Deserializer.deserialize(:createdBy, :struct, MicrosoftGraph.Model.SubjectRightsRequestCreatedBy)
     |> Deserializer.deserialize(:createdDateTime, :datetime, nil)
     |> Deserializer.deserialize(:dataSubject, :struct, MicrosoftGraph.Model.SubjectRightsRequestDataSubject)
     |> Deserializer.deserialize(:dataSubjectType, :struct, MicrosoftGraph.Model.SubjectRightsRequestDataSubjectType)
     |> Deserializer.deserialize(:history, :list, MicrosoftGraph.Model.SubjectRightsRequestHistoryInner)
     |> Deserializer.deserialize(:insight, :struct, MicrosoftGraph.Model.SubjectRightsRequestInsight)
     |> Deserializer.deserialize(:internalDueDateTime, :datetime, nil)
     |> Deserializer.deserialize(:lastModifiedBy, :struct, MicrosoftGraph.Model.SubjectRightsRequestLastModifiedBy)
     |> Deserializer.deserialize(:lastModifiedDateTime, :datetime, nil)
     |> Deserializer.deserialize(:mailboxLocations, :struct, MicrosoftGraph.Model.SubjectRightsRequestMailboxLocations)
     |> Deserializer.deserialize(:notes, :list, MicrosoftGraph.Model.MicrosoftGraphAuthoredNote)
     |> Deserializer.deserialize(:siteLocations, :struct, MicrosoftGraph.Model.SubjectRightsRequestSiteLocations)
     |> Deserializer.deserialize(:stages, :list, MicrosoftGraph.Model.SubjectRightsRequestStagesInner)
