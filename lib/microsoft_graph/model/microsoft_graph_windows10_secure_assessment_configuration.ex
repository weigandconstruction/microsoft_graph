...
defmodule MicrosoftGraph.Model.MicrosoftGraphWindows10SecureAssessmentConfiguration do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    ...
    :version => integer() | nil,
    :allowPrinting => boolean() | nil,
    :allowScreenCapture => boolean() | nil,
    :allowTextSuggestion => boolean() | nil,
    :configurationAccount => String.t | nil,
    :launchUri => String.t | nil
  }
