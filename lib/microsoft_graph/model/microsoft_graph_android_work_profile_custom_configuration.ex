...
defmodule MicrosoftGraph.Model.MicrosoftGraphAndroidWorkProfileCustomConfiguration do
  ...
  @type t :: %__MODULE__{
          ...
          :version => integer() | nil,
          :omaSettings =>
            [MicrosoftGraph.Model.AndroidWorkProfileCustomConfigurationOmaSettingsInner.t()] | nil
        }
  ...
  def decode(value) do
    ...
    |> Deserializer.deserialize(
      :omaSettings,
      :list,
      MicrosoftGraph.Model.AndroidWorkProfileCustomConfigurationOmaSettingsInner
    )
  end
end
