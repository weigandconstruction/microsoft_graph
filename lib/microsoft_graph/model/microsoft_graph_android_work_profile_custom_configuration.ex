...
defmodule MicrosoftGraph.Model.MicrosoftGraphAndroidWorkProfileCustomConfiguration do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    ...
    :version => integer() | nil,
    :omaSettings => [MicrosoftGraph.Model.AndroidWorkProfileCustomConfigurationOmaSettingsInner.t] | nil
  }
  ...
  def decode(value) do
    value
     ...
     |> Deserializer.deserialize(:omaSettings, :list, MicrosoftGraph.Model.AndroidWorkProfileCustomConfigurationOmaSettingsInner)
  end
end
