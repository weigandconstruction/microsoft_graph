...
defmodule MicrosoftGraph.Model.MicrosoftGraphSwapShiftsChangeRequest do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    ...
    :recipientActionDateTime => DateTime.t | nil,
    :recipientActionMessage => String.t | nil,
    :recipientUserId => String.t | nil,
    :senderShiftId => String.t | nil,
    :recipientShiftId => String.t | nil
  }
  ...
  def decode(value) do
    value
     ...
     |> Deserializer.deserialize(:recipientActionDateTime, :datetime, nil)
  end
end
