...
defmodule MicrosoftGraph.Model.PermissionGrantedToIdentitiesV2Inner do
  @moduledoc """
  ...
  def decode(value) do
    value
     ...
     |> Deserializer.deserialize(:siteGroup, :struct, MicrosoftGraph.Model.SharePointIdentitySetSiteGroup)
     |> Deserializer.deserialize(:siteUser, :struct, MicrosoftGraph.Model.SharePointIdentitySetSiteUser)
  end
end
