...
defmodule MicrosoftGraph.Model.MicrosoftGraphWin32LobApp do
  ...
  def decode(value) do
    value
     ...
     |> Deserializer.deserialize(:installExperience, :struct, MicrosoftGraph.Model.Win32LobAppInstallExperience)
     |> Deserializer.deserialize(:msiInformation, :struct, MicrosoftGraph.Model.Win32LobAppMsiInformation)
     |> Deserializer.deserialize(:returnCodes, :list, MicrosoftGraph.Model.Win32LobAppReturnCodesInner)
