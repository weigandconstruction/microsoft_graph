...
defmodule MicrosoftGraph.Model.CollectionOfTodoTaskAllOfValueInner do
  @moduledoc """
  ...
  def decode(value) do
    value
     |> Deserializer.deserialize(:attachmentSessions, :list, MicrosoftGraph.Model.MicrosoftGraphAttachmentSession)
     |> Deserializer.deserialize(:attachments, :list, MicrosoftGraph.Model.MicrosoftGraphAttachmentBase)
     ...
     |> Deserializer.deserialize(:checklistItems, :list, MicrosoftGraph.Model.MicrosoftGraphChecklistItem)
     |> Deserializer.deserialize(:completedDateTime, :struct, MicrosoftGraph.Model.TodoTaskCompletedDateTime)
     ...
     |> Deserializer.deserialize(:importance, :struct, MicrosoftGraph.Model.MicrosoftGraphImportance)
     |> Deserializer.deserialize(:lastModifiedDateTime, :datetime, nil)
     |> Deserializer.deserialize(:linkedResources, :list, MicrosoftGraph.Model.MicrosoftGraphLinkedResource)
     |> Deserializer.deserialize(:recurrence, :struct, MicrosoftGraph.Model.TodoTaskRecurrence)
     |> Deserializer.deserialize(:reminderDateTime, :struct, MicrosoftGraph.Model.TodoTaskReminderDateTime)
     |> Deserializer.deserialize(:startDateTime, :struct, MicrosoftGraph.Model.TodoTaskStartDateTime)
