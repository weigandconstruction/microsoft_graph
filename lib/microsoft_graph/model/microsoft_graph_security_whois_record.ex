...
defmodule MicrosoftGraph.Model.MicrosoftGraphSecurityWhoisRecord do
  @moduledoc """
  ...
  def decode(value) do
    value
     ...
     |> Deserializer.deserialize(:history, :list, MicrosoftGraph.Model.MicrosoftGraphSecurityWhoisHistoryRecord)
  end
end
