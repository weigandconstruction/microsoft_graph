...
defmodule MicrosoftGraph.Model.MicrosoftGraphMicrosoftStoreForBusinessApp do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    ...
    :licenseType => MicrosoftGraph.Model.MicrosoftGraphMicrosoftStoreForBusinessLicenseType.t | nil,
    :packageIdentityName => String.t | nil,
  ...
  def decode(value) do
    value
     ...
     |> Deserializer.deserialize(:licenseType, :struct, MicrosoftGraph.Model.MicrosoftGraphMicrosoftStoreForBusinessLicenseType)
  end
end
