...
defmodule MicrosoftGraph.Model.MicrosoftGraphEmailFileAssessmentRequest do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    ...
    :destinationRoutingReason => MicrosoftGraph.Model.MailAssessmentRequestDestinationRoutingReason.t | nil,
    :recipientEmail => String.t | nil
  }
  ...
  def decode(value) do
    value
     ...
     |> Deserializer.deserialize(:destinationRoutingReason, :struct, MicrosoftGraph.Model.MailAssessmentRequestDestinationRoutingReason)
  end
end
