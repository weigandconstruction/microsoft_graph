...
defmodule MicrosoftGraph.Model.MicrosoftGraphWindowsMicrosoftEdgeApp do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    ...
    :channel => MicrosoftGraph.Model.MicrosoftGraphMicrosoftEdgeChannel.t | nil,
    :displayLanguageLocale => String.t | nil
  }
  ...
  def decode(value) do
    value
     ...
     |> Deserializer.deserialize(:channel, :struct, MicrosoftGraph.Model.MicrosoftGraphMicrosoftEdgeChannel)
  end
end
