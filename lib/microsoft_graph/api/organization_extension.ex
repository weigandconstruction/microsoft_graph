...
defmodule MicrosoftGraph.Api.OrganizationExtension do
  @moduledoc """
  API calls for all endpoints tagged `OrganizationExtension`.
  """
  ...
  def organization_create_extensions(
    ...
    request =
      %{}
      |> method(:post)
      |> url("/organization/#{organization_id}/extensions")
  ...
  def organization_delete_extensions(connection, organization_id, extension_id, opts \\ []) do
    ...
    request =
      %{}
      |> method(:delete)
      |> url("/organization/#{organization_id}/extensions/#{extension_id}")
  ...
  def organization_extensions_get_count_bee2(connection, organization_id, opts \\ []) do
    ...
    request =
      %{}
      |> method(:get)
      |> url("/organization/#{organization_id}/extensions/$count")
      |> add_optional_params(optional_params, opts)
      |> Enum.into([])
