...
defmodule MicrosoftGraph.Api.ServicePrincipalsTokenLifetimePolicy do
  @moduledoc """
  API calls for all endpoints tagged `ServicePrincipalsTokenLifetimePolicy`.
  """
  ...
  def service_principals_list_token_lifetime_policies(connection, service_principal_id, opts \\ []) do
    ...
    request =
      %{}
      |> method(:get)
      |> url("/servicePrincipals/#{service_principal_id}/tokenLifetimePolicies")
      |> add_optional_params(optional_params, opts)
      |> Enum.into([])
  ...
  def service_principals_token_lifetime_policies_get_count4121(connection, service_principal_id, opts \\ []) do
    ...
    request =
      %{}
      |> method(:get)
      |> url("/servicePrincipals/#{service_principal_id}/tokenLifetimePolicies/$count")
      |> add_optional_params(optional_params, opts)
      |> Enum.into([])
