...
defmodule MicrosoftGraph.Api.DirectoryObjectsActions do
  @moduledoc """
  API calls for all endpoints tagged `DirectoryObjectsActions`.
  """
  ...
  def directory_objects_directory_object_check_member_groups(
    ...
    request =
      %{}
      |> method(:post)
      |> url("/directoryObjects/#{directory_object_id}/checkMemberGroups")
  ...
  def directory_objects_directory_object_get_member_groups(
    ...
    request =
      %{}
      |> method(:post)
      |> url("/directoryObjects/#{directory_object_id}/getMemberGroups")
  ...
  def directory_objects_directory_object_get_member_objects(
    ...
    request =
      %{}
      |> method(:post)
      |> url("/directoryObjects/#{directory_object_id}/getMemberObjects")
      |> add_param(:body, :body, contacts_org_contact_get_member_groups_request)
      |> Enum.into([])
  ...
  def directory_objects_directory_object_restore(connection, directory_object_id, _opts \\ []) do
    request =
      %{}
      |> method(:post)
      |> url("/directoryObjects/#{directory_object_id}/restore")
      |> ensure_body()
      |> Enum.into([])
  ...
  def directory_objects_validate_properties(
    ...
    request =
      %{}
      |> method(:post)
      |> url("/directoryObjects/validateProperties")
