...
defmodule MicrosoftGraph.Api.DevicesExtension do
  @moduledoc """
  API calls for all endpoints tagged `DevicesExtension`.
  """
  ...
  def devices_create_extensions(connection, device_id, microsoft_graph_extension, _opts \\ []) do
    request =
      %{}
      |> method(:post)
      |> url("/devices/#{device_id}/extensions")
  ...
  def devices_delete_extensions(connection, device_id, extension_id, opts \\ []) do
    ...
    request =
      %{}
      |> method(:delete)
      |> url("/devices/#{device_id}/extensions/#{extension_id}")
  ...
  def devices_extensions_get_count40b0(connection, device_id, opts \\ []) do
    ...
    request =
      %{}
      |> method(:get)
      |> url("/devices/#{device_id}/extensions/$count")
      |> add_optional_params(optional_params, opts)
      |> Enum.into([])
