...
defmodule MicrosoftGraph.Api.PermissionGrantsActions do
  ...
  """
  @spec permission_grants_get_available_extension_properties(
          Tesla.Env.client(),
          ...
          | {:error, Tesla.Env.t()}
  def permission_grants_get_available_extension_properties(
        connection,
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec permission_grants_get_by_ids(
          Tesla.Env.client(),
  ...
  @spec permission_grants_resource_specific_permission_grant_check_member_groups(
          ...
          | {:ok, MicrosoftGraph.Model.MicrosoftGraphODataErrorsODataError.t()}
          | {:error, Tesla.Env.t()}
  def permission_grants_resource_specific_permission_grant_check_member_groups(
        connection,
  ...
  @spec permission_grants_resource_specific_permission_grant_check_member_objects(
          ...
          | {:ok, MicrosoftGraph.Model.MicrosoftGraphODataErrorsODataError.t()}
          | {:error, Tesla.Env.t()}
  def permission_grants_resource_specific_permission_grant_check_member_objects(
        connection,
        resource_specific_permission_grant_id,
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec permission_grants_resource_specific_permission_grant_get_member_groups(
          Tesla.Env.client(),
          String.t(),
          ...
          | {:ok, MicrosoftGraph.Model.MicrosoftGraphODataErrorsODataError.t()}
          | {:error, Tesla.Env.t()}
  def permission_grants_resource_specific_permission_grant_get_member_groups(
        connection,
        resource_specific_permission_grant_id,
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec permission_grants_resource_specific_permission_grant_get_member_objects(
          Tesla.Env.client(),
          String.t(),
          MicrosoftGraph.Model.ContactsOrgContactGetMemberGroupsRequest.t(),
          keyword()
          ...
          | {:ok, MicrosoftGraph.Model.MicrosoftGraphODataErrorsODataError.t()}
          | {:error, Tesla.Env.t()}
  def permission_grants_resource_specific_permission_grant_get_member_objects(
        connection,
        resource_specific_permission_grant_id,
        contacts_org_contact_get_member_groups_request,
        _opts \\ []
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec permission_grants_resource_specific_permission_grant_restore(
          Tesla.Env.client(),
          String.t(),
          keyword()
        ) ::
          ...
          | {:ok, MicrosoftGraph.Model.MicrosoftGraphODataErrorsODataError.t()}
          | {:error, Tesla.Env.t()}
  def permission_grants_resource_specific_permission_grant_restore(
        connection,
        resource_specific_permission_grant_id,
        _opts \\ []
      ) do
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec permission_grants_validate_properties(
          Tesla.Env.client(),
          ...
          | {:ok, MicrosoftGraph.Model.MicrosoftGraphODataErrorsODataError.t()}
          | {:error, Tesla.Env.t()}
  def permission_grants_validate_properties(
        connection,
