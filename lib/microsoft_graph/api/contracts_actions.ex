...
defmodule MicrosoftGraph.Api.ContractsActions do
  ...
  """
  @spec contracts_contract_check_member_groups(
          Tesla.Env.client(),
          String.t(),
          ...
          | {:error, Tesla.Env.t()}
  def contracts_contract_check_member_groups(
        connection,
        contract_id,
  ...
  @spec contracts_contract_check_member_objects(
          ...
          | {:ok, MicrosoftGraph.Model.MicrosoftGraphODataErrorsODataError.t()}
          | {:error, Tesla.Env.t()}
  def contracts_contract_check_member_objects(
        connection,
        contract_id,
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec contracts_contract_get_member_groups(
          Tesla.Env.client(),
          String.t(),
          ...
          | {:ok, MicrosoftGraph.Model.MicrosoftGraphODataErrorsODataError.t()}
          | {:error, Tesla.Env.t()}
  def contracts_contract_get_member_groups(
        connection,
        contract_id,
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec contracts_contract_get_member_objects(
          Tesla.Env.client(),
          String.t(),
          MicrosoftGraph.Model.ContactsOrgContactGetMemberGroupsRequest.t(),
          keyword()
          ...
          | {:ok, MicrosoftGraph.Model.MicrosoftGraphODataErrorsODataError.t()}
          | {:error, Tesla.Env.t()}
  def contracts_contract_get_member_objects(
        connection,
        contract_id,
        contacts_org_contact_get_member_groups_request,
        _opts \\ []
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec contracts_contract_restore(Tesla.Env.client(), String.t(), keyword()) ::
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec contracts_get_available_extension_properties(
          Tesla.Env.client(),
          ...
          | {:ok, MicrosoftGraph.Model.MicrosoftGraphODataErrorsODataError.t()}
          | {:error, Tesla.Env.t()}
  def contracts_get_available_extension_properties(
        connection,
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec contracts_validate_properties(
          Tesla.Env.client(),
