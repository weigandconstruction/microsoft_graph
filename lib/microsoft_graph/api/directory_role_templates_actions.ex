...
defmodule MicrosoftGraph.Api.DirectoryRoleTemplatesActions do
  ...
  """
  @spec directory_role_templates_directory_role_template_check_member_groups(
          Tesla.Env.client(),
          String.t(),
          ...
          | {:error, Tesla.Env.t()}
  def directory_role_templates_directory_role_template_check_member_groups(
        connection,
  ...
  @spec directory_role_templates_directory_role_template_check_member_objects(
          ...
          | {:ok, MicrosoftGraph.Model.MicrosoftGraphODataErrorsODataError.t()}
          | {:error, Tesla.Env.t()}
  def directory_role_templates_directory_role_template_check_member_objects(
        connection,
        directory_role_template_id,
  ...
  @spec directory_role_templates_directory_role_template_get_member_groups(
          ...
          | {:ok, MicrosoftGraph.Model.MicrosoftGraphODataErrorsODataError.t()}
          | {:error, Tesla.Env.t()}
  def directory_role_templates_directory_role_template_get_member_groups(
        connection,
        directory_role_template_id,
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec directory_role_templates_directory_role_template_get_member_objects(
          Tesla.Env.client(),
          String.t(),
          MicrosoftGraph.Model.ContactsOrgContactGetMemberGroupsRequest.t(),
          keyword()
          ...
          | {:ok, MicrosoftGraph.Model.MicrosoftGraphODataErrorsODataError.t()}
          | {:error, Tesla.Env.t()}
  def directory_role_templates_directory_role_template_get_member_objects(
        connection,
        directory_role_template_id,
        contacts_org_contact_get_member_groups_request,
        _opts \\ []
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec directory_role_templates_directory_role_template_restore(
          Tesla.Env.client(),
          String.t(),
          keyword()
        ) ::
          ...
          | {:ok, MicrosoftGraph.Model.MicrosoftGraphODataErrorsODataError.t()}
          | {:error, Tesla.Env.t()}
  def directory_role_templates_directory_role_template_restore(
        connection,
        directory_role_template_id,
        _opts \\ []
      ) do
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec directory_role_templates_get_available_extension_properties(
          Tesla.Env.client(),
          ...
          | {:ok, MicrosoftGraph.Model.MicrosoftGraphODataErrorsODataError.t()}
          | {:error, Tesla.Env.t()}
  def directory_role_templates_get_available_extension_properties(
        connection,
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec directory_role_templates_get_by_ids(
          Tesla.Env.client(),
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec directory_role_templates_validate_properties(
          Tesla.Env.client(),
          ...
          | {:ok, MicrosoftGraph.Model.MicrosoftGraphODataErrorsODataError.t()}
          | {:error, Tesla.Env.t()}
  def directory_role_templates_validate_properties(
        connection,
