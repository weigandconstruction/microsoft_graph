...
defmodule MicrosoftGraph.Api.ContactsActions do
  ...
  """
  @spec contacts_get_available_extension_properties(
          Tesla.Env.client(),
          ...
          | {:error, Tesla.Env.t()}
  def contacts_get_available_extension_properties(
        connection,
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec contacts_org_contact_check_member_groups(
          Tesla.Env.client(),
          String.t(),
          ...
          | {:ok, MicrosoftGraph.Model.MicrosoftGraphODataErrorsODataError.t()}
          | {:error, Tesla.Env.t()}
  def contacts_org_contact_check_member_groups(
        connection,
        org_contact_id,
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec contacts_org_contact_check_member_objects(
          Tesla.Env.client(),
          String.t(),
          ...
          | {:ok, MicrosoftGraph.Model.MicrosoftGraphODataErrorsODataError.t()}
          | {:error, Tesla.Env.t()}
  def contacts_org_contact_check_member_objects(
        connection,
        org_contact_id,
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec contacts_org_contact_get_member_groups(
          Tesla.Env.client(),
          String.t(),
          ...
          | {:ok, MicrosoftGraph.Model.MicrosoftGraphODataErrorsODataError.t()}
          | {:error, Tesla.Env.t()}
  def contacts_org_contact_get_member_groups(
        connection,
        org_contact_id,
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec contacts_org_contact_get_member_objects(
          Tesla.Env.client(),
          String.t(),
          MicrosoftGraph.Model.ContactsOrgContactGetMemberGroupsRequest.t(),
          keyword()
          ...
          | {:ok, MicrosoftGraph.Model.MicrosoftGraphODataErrorsODataError.t()}
          | {:error, Tesla.Env.t()}
  def contacts_org_contact_get_member_objects(
        connection,
        org_contact_id,
        contacts_org_contact_get_member_groups_request,
        _opts \\ []
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec contacts_org_contact_restore(Tesla.Env.client(), String.t(), keyword()) ::
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec contacts_org_contact_retry_service_provisioning(Tesla.Env.client(), String.t(), keyword()) ::
          {:ok, nil}
          | {:ok, MicrosoftGraph.Model.MicrosoftGraphODataErrorsODataError.t()}
          | {:error, Tesla.Env.t()}
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec contacts_validate_properties(
          Tesla.Env.client(),
