...
defmodule MicrosoftGraph.Api.GroupsResourceSpecificPermissionGrant do
  @moduledoc """
  API calls for all endpoints tagged `GroupsResourceSpecificPermissionGrant`.
  """
  ...
  def groups_create_permission_grants(
    ...
    request =
      %{}
      |> method(:post)
      |> url("/groups/#{group_id}/permissionGrants")
  ...
  def groups_delete_permission_grants(
    ...
    request =
      %{}
      |> method(:delete)
      |> url("/groups/#{group_id}/permissionGrants/#{resource_specific_permission_grant_id}")
  ...
  def groups_permission_grants_get_count76af(connection, group_id, opts \\ []) do
    ...
    request =
      %{}
      |> method(:get)
      |> url("/groups/#{group_id}/permissionGrants/$count")
      |> add_optional_params(optional_params, opts)
      |> Enum.into([])
