...
defmodule MicrosoftGraph.Api.GroupSettingTemplatesFunctions do
  @moduledoc """
  API calls for all endpoints tagged `GroupSettingTemplatesFunctions`.
  """
  ...
  def group_setting_templates_delta(connection, opts \\ []) do
    ...
    request =
      %{}
      |> method(:get)
      |> url("/groupSettingTemplates/delta()")
