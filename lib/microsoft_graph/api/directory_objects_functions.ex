...
defmodule MicrosoftGraph.Api.DirectoryObjectsFunctions do
  ...
  """
  @spec directory_objects_delta(Tesla.Env.client, keyword()) :: {:ok, MicrosoftGraph.Model.CollectionOfDirectoryObject1.t} | {:ok, MicrosoftGraph.Model.MicrosoftGraphODataErrorsODataError.t} | {:error, Tesla.Env.t}
