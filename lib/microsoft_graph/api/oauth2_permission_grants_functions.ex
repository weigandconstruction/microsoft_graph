...
defmodule MicrosoftGraph.Api.Oauth2PermissionGrantsFunctions do
  @moduledoc """
  API calls for all endpoints tagged `Oauth2PermissionGrantsFunctions`.
  """
  ...
  def oauth2_permission_grants_delta(connection, opts \\ []) do
    ...
    request =
      %{}
      |> method(:get)
      |> url("/oauth2PermissionGrants/delta()")
    ...
    |> evaluate_response([
      {"2XX", MicrosoftGraph.Model.CollectionOfOAuth2PermissionGrant},
