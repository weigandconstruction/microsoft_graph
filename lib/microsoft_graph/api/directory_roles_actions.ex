...
defmodule MicrosoftGraph.Api.DirectoryRolesActions do
  @moduledoc """
  API calls for all endpoints tagged `DirectoryRolesActions`.
  """
  ...
  """
  @spec directory_roles_directory_role_check_member_groups(Tesla.Env.client, String.t, MicrosoftGraph.Model.ContractsContractCheckMemberGroupsRequest.t, keyword()) :: {:ok, MicrosoftGraph.Model.ContractsContractCheckMemberGroups2XxResponse.t} | {:ok, MicrosoftGraph.Model.MicrosoftGraphODataErrorsODataError.t} | {:error, Tesla.Env.t}
  def directory_roles_directory_role_check_member_groups(connection, directory_role_id, contracts_contract_check_member_groups_request, _opts \\ []) do
    request =
      %{}
      |> method(:post)
      |> url("/directoryRoles/#{directory_role_id}/checkMemberGroups")
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec directory_roles_directory_role_check_member_objects(Tesla.Env.client, String.t, MicrosoftGraph.Model.DirectoryRoleTemplatesDirectoryRoleTemplateCheckMemberObjectsRequest.t, keyword()) :: {:ok, MicrosoftGraph.Model.ContractsContractCheckMemberGroups2XxResponse.t} | {:ok, MicrosoftGraph.Model.MicrosoftGraphODataErrorsODataError.t} | {:error, Tesla.Env.t}
  def directory_roles_directory_role_check_member_objects(connection, directory_role_id, directory_role_templates_directory_role_template_check_member_objects_request, _opts \\ []) do
    request =
      %{}
      |> method(:post)
      |> url("/directoryRoles/#{directory_role_id}/checkMemberObjects")
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec directory_roles_directory_role_get_member_groups(Tesla.Env.client, String.t, MicrosoftGraph.Model.ContactsOrgContactGetMemberGroupsRequest.t, keyword()) :: {:ok, MicrosoftGraph.Model.ContractsContractCheckMemberGroups2XxResponse.t} | {:ok, MicrosoftGraph.Model.MicrosoftGraphODataErrorsODataError.t} | {:error, Tesla.Env.t}
  def directory_roles_directory_role_get_member_groups(connection, directory_role_id, contacts_org_contact_get_member_groups_request, _opts \\ []) do
    request =
      %{}
      |> method(:post)
      |> url("/directoryRoles/#{directory_role_id}/getMemberGroups")
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec directory_roles_directory_role_get_member_objects(Tesla.Env.client, String.t, MicrosoftGraph.Model.ContactsOrgContactGetMemberGroupsRequest.t, keyword()) :: {:ok, MicrosoftGraph.Model.ContractsContractCheckMemberGroups2XxResponse.t} | {:ok, MicrosoftGraph.Model.MicrosoftGraphODataErrorsODataError.t} | {:error, Tesla.Env.t}
  def directory_roles_directory_role_get_member_objects(connection, directory_role_id, contacts_org_contact_get_member_groups_request, _opts \\ []) do
    request =
      %{}
      |> method(:post)
      |> url("/directoryRoles/#{directory_role_id}/getMemberObjects")
      |> add_param(:body, :body, contacts_org_contact_get_member_groups_request)
      |> Enum.into([])
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec directory_roles_directory_role_restore(Tesla.Env.client, String.t, keyword()) :: {:ok, MicrosoftGraph.Model.OrganizationOrganizationRestore2XxResponse.t} | {:ok, MicrosoftGraph.Model.MicrosoftGraphODataErrorsODataError.t} | {:error, Tesla.Env.t}
  def directory_roles_directory_role_restore(connection, directory_role_id, _opts \\ []) do
    request =
      %{}
      |> method(:post)
      |> url("/directoryRoles/#{directory_role_id}/restore")
      |> ensure_body()
      |> Enum.into([])
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec directory_roles_get_available_extension_properties(Tesla.Env.client, MicrosoftGraph.Model.DirectoryDeletedItemsGetAvailableExtensionPropertiesRequest.t, keyword()) :: {:ok, MicrosoftGraph.Model.CollectionOfExtensionProperty.t} | {:ok, MicrosoftGraph.Model.MicrosoftGraphODataErrorsODataError.t} | {:error, Tesla.Env.t}
  def directory_roles_get_available_extension_properties(connection, directory_deleted_items_get_available_extension_properties_request, _opts \\ []) do
    request =
      %{}
      |> method(:post)
      |> url("/directoryRoles/getAvailableExtensionProperties")
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec directory_roles_get_by_ids(Tesla.Env.client, MicrosoftGraph.Model.ContactsGetByIdsRequest.t, keyword()) :: {:ok, MicrosoftGraph.Model.MicrosoftGraphODataErrorsODataError.t} | {:ok, MicrosoftGraph.Model.CollectionOfDirectoryObject.t} | {:error, Tesla.Env.t}
  def directory_roles_get_by_ids(connection, contacts_get_by_ids_request, _opts \\ []) do
    request =
      %{}
      |> method(:post)
      |> url("/directoryRoles/getByIds")
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec directory_roles_validate_properties(Tesla.Env.client, MicrosoftGraph.Model.ContactsValidatePropertiesRequest.t, keyword()) :: {:ok, nil} | {:ok, MicrosoftGraph.Model.MicrosoftGraphODataErrorsODataError.t} | {:error, Tesla.Env.t}
  def directory_roles_validate_properties(connection, contacts_validate_properties_request, _opts \\ []) do
    request =
      %{}
      |> method(:post)
      |> url("/directoryRoles/validateProperties")
