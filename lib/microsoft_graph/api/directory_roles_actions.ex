...
defmodule MicrosoftGraph.Api.DirectoryRolesActions do
  ...
  """
  @spec directory_roles_directory_role_check_member_groups(
          Tesla.Env.client(),
          String.t(),
          ...
          | {:error, Tesla.Env.t()}
  def directory_roles_directory_role_check_member_groups(
        connection,
        directory_role_id,
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec directory_roles_directory_role_check_member_objects(
          Tesla.Env.client(),
          String.t(),
          ...
          | {:ok, MicrosoftGraph.Model.MicrosoftGraphODataErrorsODataError.t()}
          | {:error, Tesla.Env.t()}
  def directory_roles_directory_role_check_member_objects(
        connection,
        directory_role_id,
  ...
  @spec directory_roles_directory_role_get_member_groups(
          ...
          | {:ok, MicrosoftGraph.Model.MicrosoftGraphODataErrorsODataError.t()}
          | {:error, Tesla.Env.t()}
  def directory_roles_directory_role_get_member_groups(
        connection,
        directory_role_id,
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec directory_roles_directory_role_get_member_objects(
          Tesla.Env.client(),
          String.t(),
          MicrosoftGraph.Model.ContactsOrgContactGetMemberGroupsRequest.t(),
          keyword()
          ...
          | {:ok, MicrosoftGraph.Model.MicrosoftGraphODataErrorsODataError.t()}
          | {:error, Tesla.Env.t()}
  def directory_roles_directory_role_get_member_objects(
        connection,
        directory_role_id,
        contacts_org_contact_get_member_groups_request,
        _opts \\ []
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec directory_roles_directory_role_restore(Tesla.Env.client(), String.t(), keyword()) ::
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec directory_roles_get_available_extension_properties(
          Tesla.Env.client(),
          ...
          | {:ok, MicrosoftGraph.Model.MicrosoftGraphODataErrorsODataError.t()}
          | {:error, Tesla.Env.t()}
  def directory_roles_get_available_extension_properties(
        connection,
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec directory_roles_get_by_ids(
          Tesla.Env.client(),
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec directory_roles_validate_properties(
          Tesla.Env.client(),
          ...
          | {:ok, MicrosoftGraph.Model.MicrosoftGraphODataErrorsODataError.t()}
          | {:error, Tesla.Env.t()}
  def directory_roles_validate_properties(
        connection,
