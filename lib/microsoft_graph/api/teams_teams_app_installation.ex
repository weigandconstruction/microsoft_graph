...
defmodule MicrosoftGraph.Api.TeamsTeamsAppInstallation do
  ...
  """
  @spec teams_create_installed_apps(
          Tesla.Env.client(),
          String.t(),
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec teams_delete_installed_apps(Tesla.Env.client(), String.t(), String.t(), keyword()) ::
          {:ok, nil}
          | {:ok, MicrosoftGraph.Model.MicrosoftGraphODataErrorsODataError.t()}
          | {:error, Tesla.Env.t()}
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec teams_get_installed_apps(Tesla.Env.client(), String.t(), String.t(), keyword()) ::
          {:ok, MicrosoftGraph.Model.MicrosoftGraphTeamsAppInstallation.t()}
          | {:ok, MicrosoftGraph.Model.MicrosoftGraphODataErrorsODataError.t()}
          | {:error, Tesla.Env.t()}
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec teams_installed_apps_get_count_d47b(Tesla.Env.client(), String.t(), keyword()) ::
          {:ok, Integer.t()}
          | {:ok, MicrosoftGraph.Model.MicrosoftGraphODataErrorsODataError.t()}
          | {:error, Tesla.Env.t()}
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec teams_installed_apps_get_teams_app(Tesla.Env.client(), String.t(), String.t(), keyword()) ::
          {:ok, MicrosoftGraph.Model.MicrosoftGraphTeamsApp.t()}
          | {:ok, MicrosoftGraph.Model.MicrosoftGraphODataErrorsODataError.t()}
          | {:error, Tesla.Env.t()}
  def teams_installed_apps_get_teams_app(
        connection,
        team_id,
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec teams_installed_apps_get_teams_app_definition(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          keyword()
          ...
          | {:ok, MicrosoftGraph.Model.MicrosoftGraphODataErrorsODataError.t()}
          | {:error, Tesla.Env.t()}
  def teams_installed_apps_get_teams_app_definition(
        connection,
        team_id,
        teams_app_installation_id,
        opts \\ []
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec teams_list_installed_apps(Tesla.Env.client(), String.t(), keyword()) ::
          {:ok, MicrosoftGraph.Model.MicrosoftGraphODataErrorsODataError.t()}
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec teams_update_installed_apps(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          MicrosoftGraph.Model.MicrosoftGraphTeamsAppInstallation.t(),
