...
defmodule MicrosoftGraph.Api.DeviceAppManagementWindowsInformationProtectionPolicy do
  @moduledoc """
  API calls for all endpoints tagged `DeviceAppManagementWindowsInformationProtectionPolicy`.
  """
  ...
  - `microsoft_graph_windows_information_protection_policy` (MicrosoftGraphWindowsInformationProtectionPolicy): New navigation property
  ...
  def device_app_management_create_windows_information_protection_policies(
    ...
    |> evaluate_response([
      {"2XX", MicrosoftGraph.Model.MicrosoftGraphWindowsInformationProtectionPolicy},
  ...
  - `connection` (MicrosoftGraph.Connection): Connection to server
  - `windows_information_protection_policy_id` (String.t): The unique identifier of windowsInformationProtectionPolicy
  - `opts` (keyword): Optional parameters
  ...
  - `connection` (MicrosoftGraph.Connection): Connection to server
  - `windows_information_protection_policy_id` (String.t): The unique identifier of windowsInformationProtectionPolicy
  - `microsoft_graph_windows_information_protection_policy` (MicrosoftGraphWindowsInformationProtectionPolicy): New navigation property values
  - `opts` (keyword): Optional parameters
  ...
  def device_app_management_windows_information_protection_policies_get_count_b909(
    ...
    request =
      %{}
      |> method(:get)
      |> url("/deviceAppManagement/windowsInformationProtectionPolicies/$count")
      |> add_optional_params(optional_params, opts)
      |> Enum.into([])
