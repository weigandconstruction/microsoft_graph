...
defmodule MicrosoftGraph.Api.OrganizationActions do
  ...
  """
  @spec organization_get_available_extension_properties(
          Tesla.Env.client(),
          ...
          | {:error, Tesla.Env.t()}
  def organization_get_available_extension_properties(
        connection,
  ...
  @spec organization_organization_check_member_groups(
          ...
          | {:ok, MicrosoftGraph.Model.MicrosoftGraphODataErrorsODataError.t()}
          | {:error, Tesla.Env.t()}
  def organization_organization_check_member_groups(
        connection,
        organization_id,
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec organization_organization_check_member_objects(
          Tesla.Env.client(),
          String.t(),
          ...
          | {:ok, MicrosoftGraph.Model.MicrosoftGraphODataErrorsODataError.t()}
          | {:error, Tesla.Env.t()}
  def organization_organization_check_member_objects(
        connection,
        organization_id,
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec organization_organization_get_member_groups(
          Tesla.Env.client(),
          String.t(),
          ...
          | {:ok, MicrosoftGraph.Model.MicrosoftGraphODataErrorsODataError.t()}
          | {:error, Tesla.Env.t()}
  def organization_organization_get_member_groups(
        connection,
        organization_id,
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec organization_organization_get_member_objects(
          Tesla.Env.client(),
          String.t(),
          MicrosoftGraph.Model.ContactsOrgContactGetMemberGroupsRequest.t(),
          keyword()
          ...
          | {:ok, MicrosoftGraph.Model.MicrosoftGraphODataErrorsODataError.t()}
          | {:error, Tesla.Env.t()}
  def organization_organization_get_member_objects(
        connection,
        organization_id,
        contacts_org_contact_get_member_groups_request,
        _opts \\ []
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec organization_organization_restore(Tesla.Env.client(), String.t(), keyword()) ::
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec organization_organization_set_mobile_device_management_authority(
          Tesla.Env.client(),
          String.t(),
          keyword()
        ) ::
          ...
          | {:ok, MicrosoftGraph.Model.MicrosoftGraphODataErrorsODataError.t()}
          | {:error, Tesla.Env.t()}
  def organization_organization_set_mobile_device_management_authority(
        connection,
        organization_id,
        _opts \\ []
      ) do
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec organization_validate_properties(
          Tesla.Env.client(),
          ...
          | {:ok, MicrosoftGraph.Model.MicrosoftGraphODataErrorsODataError.t()}
          | {:error, Tesla.Env.t()}
  def organization_validate_properties(
        connection,
