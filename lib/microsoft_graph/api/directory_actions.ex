...
defmodule MicrosoftGraph.Api.DirectoryActions do
  ...
  @spec directory_deleted_items_directory_object_check_member_groups(
          ...
          | {:error, Tesla.Env.t()}
  def directory_deleted_items_directory_object_check_member_groups(
        connection,
        directory_object_id,
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec directory_deleted_items_directory_object_check_member_objects(
          Tesla.Env.client(),
          String.t(),
          ...
          | {:ok, MicrosoftGraph.Model.MicrosoftGraphODataErrorsODataError.t()}
          | {:error, Tesla.Env.t()}
  def directory_deleted_items_directory_object_check_member_objects(
        connection,
        directory_object_id,
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec directory_deleted_items_directory_object_get_member_groups(
          Tesla.Env.client(),
          String.t(),
          ...
          | {:ok, MicrosoftGraph.Model.MicrosoftGraphODataErrorsODataError.t()}
          | {:error, Tesla.Env.t()}
  def directory_deleted_items_directory_object_get_member_groups(
        connection,
        directory_object_id,
  ...
  @spec directory_deleted_items_directory_object_get_member_objects(
          ...
          | {:ok, MicrosoftGraph.Model.MicrosoftGraphODataErrorsODataError.t()}
          | {:error, Tesla.Env.t()}
  def directory_deleted_items_directory_object_get_member_objects(
        connection,
        directory_object_id,
        contacts_org_contact_get_member_groups_request,
        _opts \\ []
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec directory_deleted_items_directory_object_restore(
          Tesla.Env.client(),
          String.t(),
          keyword()
        ) ::
          ...
          | {:ok, MicrosoftGraph.Model.MicrosoftGraphODataErrorsODataError.t()}
          | {:error, Tesla.Env.t()}
  def directory_deleted_items_directory_object_restore(
        connection,
        directory_object_id,
        _opts \\ []
      ) do
  ...
  @spec directory_deleted_items_get_available_extension_properties(
          ...
          | {:ok, MicrosoftGraph.Model.MicrosoftGraphODataErrorsODataError.t()}
          | {:error, Tesla.Env.t()}
  def directory_deleted_items_get_available_extension_properties(
        connection,
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec directory_deleted_items_get_by_ids(
          Tesla.Env.client(),
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec directory_deleted_items_validate_properties(
          Tesla.Env.client(),
          ...
          | {:ok, MicrosoftGraph.Model.MicrosoftGraphODataErrorsODataError.t()}
          | {:error, Tesla.Env.t()}
  def directory_deleted_items_validate_properties(
        connection,
