...
defmodule MicrosoftGraph.Api.DevicesActions do
  ...
  """
  @spec devices_device_check_member_groups(
          Tesla.Env.client(),
          String.t(),
          ...
          | {:error, Tesla.Env.t()}
  def devices_device_check_member_groups(
        connection,
        device_id,
  ...
  @spec devices_device_check_member_objects(
          ...
          | {:ok, MicrosoftGraph.Model.MicrosoftGraphODataErrorsODataError.t()}
          | {:error, Tesla.Env.t()}
  def devices_device_check_member_objects(
        connection,
        device_id,
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec devices_device_get_member_groups(
          Tesla.Env.client(),
          String.t(),
          ...
          | {:ok, MicrosoftGraph.Model.MicrosoftGraphODataErrorsODataError.t()}
          | {:error, Tesla.Env.t()}
  def devices_device_get_member_groups(
        connection,
        device_id,
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec devices_device_get_member_objects(
          Tesla.Env.client(),
          String.t(),
          MicrosoftGraph.Model.ContactsOrgContactGetMemberGroupsRequest.t(),
          keyword()
          ...
          | {:ok, MicrosoftGraph.Model.MicrosoftGraphODataErrorsODataError.t()}
          | {:error, Tesla.Env.t()}
  def devices_device_get_member_objects(
        connection,
        device_id,
        contacts_org_contact_get_member_groups_request,
        _opts \\ []
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec devices_device_restore(Tesla.Env.client(), String.t(), keyword()) ::
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec devices_get_available_extension_properties(
          Tesla.Env.client(),
          ...
          | {:ok, MicrosoftGraph.Model.MicrosoftGraphODataErrorsODataError.t()}
          | {:error, Tesla.Env.t()}
  def devices_get_available_extension_properties(
        connection,
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec devices_validate_properties(
          Tesla.Env.client(),
