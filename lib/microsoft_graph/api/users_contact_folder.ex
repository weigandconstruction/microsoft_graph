...
defmodule MicrosoftGraph.Api.UsersContactFolder do
  @moduledoc """
  API calls for all endpoints tagged `UsersContactFolder`.
  """
  ...
  def users_contact_folders_child_folders_get_count9149(
    ...
    request =
      %{}
      |> method(:get)
      |> url("/users/#{user_id}/contactFolders/#{contact_folder_id}/childFolders/$count")
      |> add_optional_params(optional_params, opts)
      |> Enum.into([])
  ...
  def users_contact_folders_contacts_get_count5cc4(
    ...
    request =
      %{}
      |> method(:get)
      |> url("/users/#{user_id}/contactFolders/#{contact_folder_id}/contacts/$count")
      |> add_optional_params(optional_params, opts)
      |> Enum.into([])
  ...
  def users_contact_folders_contacts_get_photo(
    ...
    request =
      %{}
      |> method(:get)
      |> url("/users/#{user_id}/contactFolders/#{contact_folder_id}/contacts/#{contact_id}/photo")
      |> add_optional_params(optional_params, opts)
      |> Enum.into([])
  ...
  def users_contact_folders_create_child_folders(
    ...
    request =
      %{}
      |> method(:post)
      |> url("/users/#{user_id}/contactFolders/#{contact_folder_id}/childFolders")
  ...
  def users_contact_folders_create_contacts(
    ...
    request =
      %{}
      |> method(:post)
      |> url("/users/#{user_id}/contactFolders/#{contact_folder_id}/contacts")
      |> add_param(:body, :body, microsoft_graph_contact)
      |> Enum.into([])
  ...
  def users_contact_folders_delete_contacts(
    ...
    request =
      %{}
      |> method(:delete)
      |> url("/users/#{user_id}/contactFolders/#{contact_folder_id}/contacts/#{contact_id}")
      |> add_optional_params(optional_params, opts)
      |> Enum.into([])
  ...
  def users_contact_folders_get_count72bb(connection, user_id, opts \\ []) do
    ...
    request =
      %{}
      |> method(:get)
      |> url("/users/#{user_id}/contactFolders/$count")
      |> add_optional_params(optional_params, opts)
      |> Enum.into([])
  ...
  def users_create_contact_folders(
    ...
    request =
      %{}
      |> method(:post)
      |> url("/users/#{user_id}/contactFolders")
      |> add_param(:body, :body, microsoft_graph_contact_folder)
      |> Enum.into([])
  ...
  def users_delete_contact_folders(connection, user_id, contact_folder_id, opts \\ []) do
    ...
    request =
      %{}
      |> method(:delete)
      |> url("/users/#{user_id}/contactFolders/#{contact_folder_id}")
      |> add_optional_params(optional_params, opts)
      |> Enum.into([])
