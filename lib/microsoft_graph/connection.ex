...
defmodule MicrosoftGraph.Connection do
  @moduledoc """
  Handle Tesla connections for MicrosoftGraph.

  Additional middleware can be set in the compile-time or runtime configuration:

      config :tesla, MicrosoftGraph.Connection,
  ...
  def middleware(options \\ []) do
    base_url =
      Keyword.get(
        options,
        :base_url,
        Application.get_env(:microsoft_graph, :base_url, @default_base_url)
      )
    ...
    user_agent =
      Keyword.get(
        ...
        Keyword.get(
          tesla_options,
          :user_agent,
          "openapi-generator - MicrosoftGraph v1.0 - elixir"
        )
      )
